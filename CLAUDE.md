...
**showrunner** is an AI agent orchestration engine for tabletop RPG sessions, initially targeting the Genesys/Star Wars FFG system.
...
- These contain source materials like the Genesys Core Rulebook.
...
Python virtual environment at `venv/` (to be configured once dependencies are defined):
